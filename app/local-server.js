...
const server = http.createServer(async (req, res) => {
  ...
  try {
    ...
    if (req.url === '/2015-03-31/functions/function/invocations' && req.method === 'POST') {
...
server.listen(PORT, () => {
  ...
  console.log(`Lambda runtime interface: curl -XPOST "http://localhost:${PORT}/2015-03-31/functions/function/invocations" -H "Content-Type: application/json" -d '{}'`);
